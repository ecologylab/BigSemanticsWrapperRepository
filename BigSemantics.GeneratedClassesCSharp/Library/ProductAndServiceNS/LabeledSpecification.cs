...
{
	[SimplInherit]
	public class LabeledSpecification : Metadata
	{
		[SimplScalar]
		...
		public LabeledSpecification()
		{ }

		public LabeledSpecification(MetaMetadataCompositeField mmd) : base(mmd) { }
