	...
	public class RepositoryMetadataTypesScope
	{
		...
		public static SimplTypesScope Get()
		{
			return SimplTypesScope.Get("repository_metadata", MetadataBuiltinsTypesScope.Get(),
				...
				typeof(Event),
				typeof(Exhibition),
				typeof(FacebookGroup),
				typeof(FacebookNewsFeed),
				typeof(FacebookProfile),
				typeof(FacebookUser),
				typeof(FacebookVideo),
				typeof(FashionReviewer),
				typeof(FastflipSearch),
				typeof(Favorites),
				typeof(FileSourceItem),
				...
				typeof(GithubCommits),
				typeof(GithubIssuePage),
				typeof(GithubIssues),
				typeof(GithubProject),
				typeof(GlobeCartoon),
				typeof(GoogleBook),
				...
				typeof(InstagramHomeFeed),
				typeof(InstagramPost),
				typeof(InstagramProfile),
				typeof(InstagramTagFeed),
				typeof(InstagramVideo),
				typeof(Instructable),
