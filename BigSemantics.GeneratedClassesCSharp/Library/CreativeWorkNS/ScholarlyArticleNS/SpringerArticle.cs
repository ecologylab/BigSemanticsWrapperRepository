...
namespace Ecologylab.BigSemantics.Generated.Library.CreativeWorkNS.ScholarlyArticleNS 
{
	...
	public class SpringerArticle : SpringerBook
	{
		...
		[MmName("keywords")]
		private List<Ecologylab.BigSemantics.MetadataNS.Scalar.MetadataString> keywords;
		...
		public List<Ecologylab.BigSemantics.MetadataNS.Scalar.MetadataString> Keywords
		{
			get{return keywords;}
			set
			{
