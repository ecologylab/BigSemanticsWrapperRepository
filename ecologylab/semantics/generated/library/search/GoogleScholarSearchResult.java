...
extends  SearchResult
{
	...
	@simpl_scalar private MetadataInteger	citationCount;
...
/**
	Tests to see if the value of the field is null, or if the field itself is null: documentLink
**/ 
...
/**
	Tests to see if the value of the field is null, or if the field itself is null: citationCount
**/ 
...
/**
	Tests to see if the value of the field is null, or if the field itself is null: citationsLink
**/ 
...
{
	return relatedArticlesLink().getValue();
}
...
/**
	Tests to see if the value of the field is null, or if the field itself is null: relatedArticlesLink
**/ 
