...
public class YahooThumbnail extends Metadata
{
	/** 
	 */ 
	@simpl_scalar	@simpl_tag("Url")	@simpl_hints(Hint.XML_LEAF)	 @simpl_composite_as_scalar
	private ecologylab.semantics.metadata.scalar.MetadataParsedURL thumbUrl;

	/** 
	 */ 
	@simpl_scalar	@simpl_tag("Width")	@simpl_hints(Hint.XML_LEAF)	 @simpl_composite_as_scalar
	private ecologylab.semantics.metadata.scalar.MetadataInteger width;

	/** 
	 */ 
	@simpl_scalar	@simpl_tag("Height")	@simpl_hints(Hint.XML_LEAF)	 @simpl_composite_as_scalar
