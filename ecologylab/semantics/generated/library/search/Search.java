...
public class Search extends CompoundDocument
{
	/** 
	 */ 
	@simpl_nowrap	@simpl_collection	@simpl_classes({CiteseerxSearchResult.class, SearchResult.class, AcmPortalSearchResult.class}) @mm_name("search_results")	private ArrayList<SearchResult> searchResults;
