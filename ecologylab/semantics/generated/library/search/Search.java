...
public class Search extends Document
{
	/** 
	 */ 
	@simpl_nowrap	@simpl_collection	@simpl_classes({SearchResult.class, AcmPortalSearchResult.class, CiteseerxSearchResult.class}) @mm_name("search_results")	private List<SearchResult> searchResults;
