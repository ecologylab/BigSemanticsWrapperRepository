...
namespace ecologylab.semantics.generated.library.search 
{
	...
	public class BingSearchImageSection : CompoundDocument
	{
		...
		public BingSearchImageSection(MetaMetadataCompositeField mmd) : base(mmd) { }
		...
		public List<BingImageSearchResult> ImageSearchResults
		{
			...
			set
			{
				if (this.imageSearchResults != value)
				{
					this.imageSearchResults = value;
					this.RaisePropertyChanged( () => this.ImageSearchResults );
				}
			}
		}
	}
