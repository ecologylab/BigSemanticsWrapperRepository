...
@simpl_collection("google_book") @xml_tag("references_from_books") @mm_name("references_from_books")
private ArrayList<GoogleBook>	referencesFromBooks;
...
*/
public ArrayList<GoogleBook>	referencesFromBooks()
{
	ArrayList<GoogleBook>	result = this.referencesFromBooks;
	if (result == null)
	{
