...
public class SlashdotItem extends Item
{
	/** 
	 */ 
	@simpl_scalar	@simpl_tag("slash:department")	@simpl_hints(Hint.XML_LEAF)	 @simpl_composite_as_scalar
	private ecologylab.semantics.metadata.scalar.MetadataString department;

	/** 
	 */ 
	@simpl_scalar	@simpl_tag("slash:section")	@simpl_hints(Hint.XML_LEAF)	 @simpl_composite_as_scalar
