...
public class Patent extends CreativeWork
{
	/** 
	 */ 
	@simpl_scalar	@simpl_hints(Hint.XML_LEAF)	private ecologylab.semantics.metadata.scalar.MetadataString claims;
	...
	/** 
	 */ 
	@simpl_scalar	private ecologylab.semantics.metadata.scalar.MetadataDate filingDate;

	/** 
	 */ 
	@simpl_collection("document") @mm_name("classifications")	private List<Document> classifications;
