...
public class VideoInterview extends Document
{
	...
	@simpl_scalar
	private MetadataString position;
	...
	public MetadataString	position()
	{
		MetadataString	result = this.position;
		if (result == null)
		{
			result = new MetadataString();
	...
	{
		return this.position == null ? null : position().getValue();
	}

	public MetadataString getPositionMetadata()
	{
		return position;
	}
	...
	public void setPositionMetadata(MetadataString position)
	{
